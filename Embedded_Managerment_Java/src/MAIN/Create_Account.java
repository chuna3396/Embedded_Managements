...
public class Create_Account extends javax.swing.JPanel implements TableModelListener {

    public static Confirm_Create_Acc create_Acc = new Confirm_Create_Acc();
    ConnectMySQL cn = new ConnectMySQL();
    public static DefaultTableModel tbRequest;

    public Create_Account() {
        setPreferredSize(new Dimension(485, 726));
        initComponents();

        String[] columnNames = {"STT", "Họ tên", "Giới tính", "Ngày sinh", "CMND", "Phone", "Email", "Kích hoạt"};
        String[] m = new String[]{"Nam", "Nữ"};
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnl_Borrow, javax.swing.GroupLayout.DEFAULT_SIZE, 1020, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnl_Borrow, javax.swing.GroupLayout.DEFAULT_SIZE, 622, Short.MAX_VALUE)
        );
    ...
    public static void main(String[] args) {
        ...
        JFrame frm = new JFrame("Tạo tài khoản");
//        frm.setResizable(false);
        frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frm.setIconImage(new ImageIcon("Image/rsz_icon.png").getImage());
        frm.getContentPane().add(new Create_Account());
        frm.pack();
